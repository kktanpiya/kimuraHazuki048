		...
		android.os.Parcelable.Creator
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("com.refractored.PagerSlidingTabStrip+PagerSlidingTabStripState+SavedStateCreator, Refractored.PagerSlidingTabStrip, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", PagerSlidingTabStrip_PagerSlidingTabStripState_SavedStateCreator.class, __md_methods);
	}


	public PagerSlidingTabStrip_PagerSlidingTabStripState_SavedStateCreator () throws java.lang.Throwable
	{
		super ();
		if (getClass () == PagerSlidingTabStrip_PagerSlidingTabStripState_SavedStateCreator.class)
			mono.android.TypeManager.Activate ("com.refractored.PagerSlidingTabStrip+PagerSlidingTabStripState+SavedStateCreator, Refractored.PagerSlidingTabStrip, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
